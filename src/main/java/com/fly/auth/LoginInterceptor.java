    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (handler instanceof HandlerMethod) {
            ...
            if (token == null || "".equals(token)) {
                throw new NoPermissionException("对不起,还没登录401");
            }
            ...
            if (myToken != null) {
                ...
                String redisToken = (String) redisTemplate.opsForValue().get(myToken.getUser_name());
                if(redisToken==null || !redisToken.equals(token) || userJurisdictions == null){
